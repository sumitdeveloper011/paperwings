    ...
    <div class="page-header">
        <div class="page-header__content">
            <div class="page-header__title-section">
                ...
                <p class="page-header__subtitle">Update gallery information</p>
            </div>
            <div class="page-header__actions">
                <a href="{{ route('admin.galleries.show', $gallery) }}" class="btn btn-primary btn-icon">
        ...
        <div class="col-lg-8">
            <div class="modern-card modern-card--glass">
                ...
                <div class="modern-card__body">
                    <form method="POST" action="{{ route('admin.galleries.update', $gallery) }}" class="modern-form" id="galleryForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('admin.galleries.show', $gallery) }}" class="btn btn-outline-secondary btn-icon">
