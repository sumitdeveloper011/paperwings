...
<div class="admin-content">
    ...
    <div class="page-header">
        <div class="page-header__content">
            <div class="page-header__title-section">
                ...
                <p class="page-header__subtitle">Create a new discount coupon</p>
            </div>
    ...
    <form method="POST" action="{{ route('admin.coupons.store') }}" class="modern-form" id="couponForm">
        @csrf
                ...
                <div class="modern-card modern-card--sticky">
                    ...
                    <div class="modern-card__body">
                        ...
                        <div class="form-info">
                            <div class="info-item">
                                <i class="fas fa-info-circle"></i>
                                <span>Coupon will be available immediately after creation</span>
                            </div>
                        </div>
                    </div>
                </div>
