                        ...
                        <div class="profile-view">
                            <div class="profile-view__header">
                                <div class="profile-view__avatar-large">
                                    <img src="assets/images/product-1.jpg" alt="John Doe" id="profileViewImage" class="profile-view__avatar-img">
                            ...
                            <div class="profile-view__details">
                                ...
                                <div class="profile-detail-row">
                                    ...
                                    <div class="profile-detail-value">United States</div>
                                </div>
                                <div class="profile-detail-row">
                                    <div class="profile-detail-label">Region</div>
                                    <div class="profile-detail-value">New York</div>
                                </div>
                                <div class="profile-detail-row">
                                    <div class="profile-detail-label">District</div>
                                    <div class="profile-detail-value">New York City</div>
                                </div>
                                <div class="profile-detail-row">
                                    <div class="profile-detail-label">City</div>
                                    <div class="profile-detail-value">New York</div>
                                </div>
                                <div class="profile-detail-row">
                                    <div class="profile-detail-label">Pincode</div>
                                    <div class="profile-detail-value">10001</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="account-block">
                        ...
                        <form class="account-form" id="editProfileForm">
                            ...
                            <div class="form-group form-group--full">
                                ...
                                <div class="profile-image-upload">
                                    <div class="profile-image-upload__preview">
                                        <img src="assets/images/product-1.jpg" alt="Profile Preview" id="profileImagePreview" class="profile-image-upload__img">
                                    ...
                                    <div class="profile-image-upload__actions">
                                        ...
                                        <input type="file" id="profileImageInput" class="profile-image-upload__input" accept="image/*" style="display: none;">
                                        <button type="button" class="btn btn-outline-secondary btn-sm" id="removeProfileImage" style="display: none;">
                            ...
                            <div class="account-form__grid">
                                ...
                                <div class="form-group">
                                    <label for="editCountry" class="form-label">Country <span class="required">*</span></label>
                                    <select id="editCountry" class="form-input" required>
                                ...
                                <div class="form-group">
                                    <label for="editRegion" class="form-label">Region <span class="required">*</span></label>
                                    <select id="editRegion" class="form-input" required>
                                ...
                                <div class="form-group">
                                    <label for="editDistrict" class="form-label">District <span class="required">*</span></label>
                                    <select id="editDistrict" class="form-input" required>
                                ...
                                <div class="form-group">
                                    <label for="editCity" class="form-label">City <span class="required">*</span></label>
                                ...
                                <div class="form-group">
                                    <label for="editPincode" class="form-label">Pincode <span class="required">*</span></label>
                                    <input type="text" id="editPincode" class="form-input" value="10001" required placeholder="Enter pincode">
                                </div>
                            </div>
