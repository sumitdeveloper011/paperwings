...
<div class="col-lg-3 account-sidebar-desktop">
...
<div class="account-menu-drawer" id="accountMenuDrawer">
    <div class="account-menu-drawer__overlay" id="accountMenuDrawerOverlay"></div>
    <div class="account-menu-drawer__content">
        <div class="account-menu-drawer__header">
            <div class="account-user">
                <div class="account-user__avatar">
                    <i class="fas fa-user"></i>
                </div>
            ...
            <button class="account-menu-drawer__close" id="accountMenuDrawerClose" aria-label="Close Menu">
