                ...
                <tr>
                    <td style="padding: 0 40px 40px 40px; background-color: #ffffff;">
                        <p style="margin: 0 0 5px 0; color: #000000; font-size: 16px; font-weight: 400;">Thanks,                            </p>
                ...
                <tr>
                    <td style="padding: 40px 40px 30px 40px; background-color: #f5f5f5;">
                        <p style="margin: 0 0 15px 0; color: #2850a3; font-size: 16px; font-weight: 600; text-align: center;">
                            Get in touch
                        </p>
                ...
                <tr>
                    <td style="padding: 20px 40px; text-align: center; background-color: #2850a3;">
                        <p style="margin: 0; color: #ffffff; font-size: 12px; font-weight: 400;">
                            Copyrights © {{ $currentYear ?? date('Y') }} {{ $appName ?? config('app.name') }} All Rights Reserved
                        </p>
                    </td>
                </tr>
                </table>
