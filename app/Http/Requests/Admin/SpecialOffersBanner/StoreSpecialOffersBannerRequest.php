...
class StoreSpecialOffersBannerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'image' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:2048|dimensions:ratio=64/15',
    ...
    public function messages(): array
    {
        return [
            ...
            'image.dimensions' => 'The image must have a 4.27:1 aspect ratio (e.g., 1920x450 pixels).',
