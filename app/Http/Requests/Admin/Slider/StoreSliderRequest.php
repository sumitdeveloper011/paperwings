...
class StoreSliderRequest extends FormRequest
{
    ...
    {
        return [
            'image' => 'required|image|mimes:jpeg,png,jpg,gif|max:2048|dimensions:width=1920,height=600',
            'heading' => 'required|string|max:255',
            'sub_heading' => 'required|string|max:255',
            'button_1_name' => 'required|string|max:100',
            'button_1_url' => 'required|string|max:500',
            'button_2_name' => 'required|string|max:100',
            'button_2_url' => 'required|string|max:500',
