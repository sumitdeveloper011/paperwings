...
$(document).ready(function() {
    ...
    $('.wishlist-trigger').on('click', function(e) {
        e.preventDefault();
        $('.wishlist-sidebar-overlay').addClass('active');
...
$(document).ready(function() {
    ...
    // Password Visibility Toggle for Reset Password Field
    $('#toggleResetPassword').on('click', function() {
        const passwordInput = $('#resetPassword');
        const passwordIcon = $('#resetPasswordIcon');
    ...
    // Password Visibility Toggle for Reset Confirm Password Field
    $('#toggleResetConfirmPassword').on('click', function() {
        const confirmPasswordInput = $('#resetConfirmPassword');
        const confirmPasswordIcon = $('#resetConfirmPasswordIcon');
    ...
    // Reset Password Form Input Focus Effects
    $('.reset-password-form-input').on('focus', function() {
        $(this).css({
            'border-color': 'var(--coral-red)',
            'background': '#ffffff',
            'box-shadow': '0 0 0 4px rgba(233, 92, 103, 0.1)',
    ...
    $('.reset-password-form-input').on('blur', function() {
        if (!$(this).val()) {
            $(this).css({
                'border-color': '#e9ecef',
                'background': '#f8f9fa',
