        ...
        addToCart: function(productId, quantity = 1, button = null) {
            ...
            .then(data => {
                ...
                if (data && data.success) {
                    ...
                    if (wishlistItem) {
                        const productIdFromWishlist = wishlistItem.getAttribute('data-product-id');
                        if (productIdFromWishlist && window.WishlistFunctions && typeof window.WishlistFunctions.removeFromWishlist === 'function') {
                            window.WishlistFunctions.removeFromWishlist(productIdFromWishlist, null, true);
                        }
                    }
